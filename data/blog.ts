...
export const blogPosts: BlogPost[] = [
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'What Is Calibration? A Complete Guide | American Gage',
    metaDescription:
      'What calibration is, how it differs from verification and repair, what NIST traceability means, and how to read a certificate — from an A2LA-accredited lab.',
...

  {
    ...
    metaTitle: 'Calibration vs. Verification vs. Adjustment | American Gage',
    metaDescription:
      'Calibration, verification, adjustment, and repair are not the same, and the difference causes audit problems. Exactly what each means and when you need it.',
    category: 'Calibration Fundamentals',
    readMinutes: 6,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'What Does NIST Traceable Mean? | American Gage',
    metaDescription:
      'NIST traceable is on every certificate but rarely explained — what metrological traceability really means, why the unbroken chain matters, and what to check.',
    category: 'Calibration Fundamentals',
    readMinutes: 6,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'How to Read a Calibration Certificate | American Gage',
    metaDescription:
      'A field-by-field guide to a calibration certificate: traceability, as-found/as-left data, uncertainty, the decision rule, and red flags that fail audits.',
    category: 'Calibration Fundamentals',
    readMinutes: 7,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'As-Found vs. As-Left Calibration Data | American Gage',
    metaDescription:
      'As-found and as-left data make an out-of-tolerance impact assessment possible. What each means, why PASS-only certificates fail audits, and when you need data.',
    category: 'Calibration Fundamentals',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'TUR, TAR & Calibration Decision Rules | American Gage',
    metaDescription:
      'Test uncertainty ratio (TUR), TAR, guard banding, and the ANSI/NCSL Z540.3 decision rule explained simply — and why they decide whether a pass is really a pass.',
    category: 'Calibration Fundamentals',
    readMinutes: 7,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'ISO/IEC 17025 Accreditation Explained | American Gage',
    metaDescription:
      'What ISO/IEC 17025 accreditation proves, how it differs from ISO 9001 and plain traceable calibration, how to read an A2LA scope, and how to choose a lab.',
...

  {
    ...
    metaTitle: 'Accredited vs. Traceable Calibration | American Gage',
    metaDescription:
      'A traceable calibration and an ISO/IEC 17025 accredited one are not the same. The difference, and when an auditor rejects the non-accredited version.',
    category: 'ISO/IEC 17025 Accreditation',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'A scope of accreditation lists what a lab can measure, over what ranges, at what capability (CMC). How to read one and confirm your measurement is covered.',
    category: 'ISO/IEC 17025 Accreditation',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'ISO 17025 vs. ISO 9001 for Cal Labs | American Gage',
    metaDescription:
      'ISO 9001 and ISO/IEC 17025 solve different problems — why 9001 alone does not prove a calibration lab produces valid results, and what to require instead.',
    category: 'ISO/IEC 17025 Accreditation',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Choosing an Accredited Calibration Lab | American Gage',
    metaDescription:
      'A practical checklist for selecting a calibration supplier: accreditation and scope, certificate content, uncertainty, turnaround, and support.',
    category: 'ISO/IEC 17025 Accreditation',
    readMinutes: 6,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'What Changed in ISO/IEC 17025:2017 | American Gage',
    metaDescription:
      'The 2017 revision reshaped ISO/IEC 17025 around risk-based thinking, decision rules, and impartiality. What changed and why it matters to your certificates.',
    category: 'ISO/IEC 17025 Accreditation',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'Measurement Uncertainty & Traceability | American Gage',
    metaDescription:
      'Measurement uncertainty is the honest margin around every result. Traceability chains, budgets, CMC, and guard banding, explained by an accredited lab.',
...

  {
    ...
    metaTitle: 'What Is Measurement Uncertainty? | American Gage',
    metaDescription:
      'Measurement uncertainty explained without the math fog: what it is, why coverage factor and k=2 matter, and how to use the uncertainty on your certificate.',
    category: 'Measurement Uncertainty',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'How to Read an Uncertainty Budget | American Gage',
    metaDescription:
      'An uncertainty budget lists every contributor to measurement doubt and combines them. How Type A and B components, distributions, and expanded uncertainty fit.',
    category: 'Measurement Uncertainty',
    readMinutes: 6,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'The Metrological Traceability Chain | American Gage',
    metaDescription:
...

  {
    ...
    metaDescription:
      'Why calibration labs control to 20 C, how thermal expansion and humidity shift dimensional and electrical measurements, and why environment adds uncertainty.',
    category: 'Measurement Uncertainty',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Guard banding pulls acceptance limits inward to control the risk of falsely accepting an out-of-tolerance instrument. How it works and how it ties to Z540.3.',
    category: 'Measurement Uncertainty',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'What Is CMC (Measurement Capability)? | American Gage',
    metaDescription:
      'CMC is the smallest uncertainty a lab can achieve for a measurement, and it is on the accreditation scope. What CMC means and how to use it to judge a lab.',
    category: 'Measurement Uncertainty',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'Calibration Intervals & Scheduling Guide | American Gage',
    metaDescription:
      'How to set and defend calibration intervals, adjust them with data, run a recall system, and handle overdue instruments — without failing an audit.',
...

  {
    ...
    metaDescription:
      'A practical method for establishing calibration intervals: start from manufacturer guidance and risk, document the rationale, and defend it to an auditor.',
    category: 'Calibration Intervals',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Adjusting Calibration Intervals With Data | American Gage',
    metaDescription:
      'How to use as-found calibration history to extend intervals on stable instruments and shorten them on drifters — the data-driven approach auditors respect.',
    category: 'Calibration Intervals',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Calibration Recall Systems That Work | American Gage',
    metaDescription:
      'A recall system flags calibration due dates before they pass and keeps overdue instruments off the floor. What a good one includes and common failure modes.',
    category: 'Calibration Intervals',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Instrument Out of Tolerance: What to Do | American Gage',
    metaDescription:
      'An out-of-tolerance result triggers an impact assessment on product measured since the last good calibration. The step-by-step response auditors expect.',
    category: 'Calibration Intervals',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Instrument Drift & Stability Explained | American Gage',
    metaDescription:
      'Why instruments drift, how stability differs by instrument type, and how to read drift trends in your calibration history to manage risk and set intervals.',
    category: 'Calibration Intervals',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Managing a Gauge Crib Without Chaos | American Gage',
    metaDescription:
      'A gauge crib works when issue and return, calibration status, and accountability are controlled. The practices that keep a tool crib audit-ready.',
    category: 'Calibration Intervals',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'Calibration Requirements by Industry | American Gage',
    metaDescription:
      'How calibration requirements differ across AS9100, ISO 13485 and FDA, pharma 21 CFR, Nadcap, IATF 16949, and ITAR/defense — and what auditors actually check.',
...

  {
    ...
    metaTitle: 'Nadcap Calibration Requirements | American Gage',
    metaDescription:
...

  {
    ...
    metaTitle: 'IATF 16949 Calibration Requirements | American Gage',
    metaDescription:
      'What IATF 16949 expects for calibration and measurement systems analysis (MSA): traceability, records, lab scope, and the automotive-specific twists.',
    category: 'Industry Compliance',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'ITAR & Defense Calibration Considerations | American Gage',
    metaDescription:
      'What defense manufacturers should know about calibration under ITAR: traceability, records, and handling controlled technical data with a domestic U.S. lab.',
    category: 'Industry Compliance',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'What Auditors Check on Calibration | American Gage',
    metaDescription:
      'The calibration questions customer and registrar auditors reliably ask — traceability, data, intervals, out-of-tolerance handling — and how to prepare.',
    category: 'Industry Compliance',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'Dimensional Metrology & Calibration Guide | American Gage',
    metaDescription:
      'A guide to dimensional calibration: calipers, micrometers, gauge blocks, CMMs, surface plates, and thread gauges — what certificates show and why 20 C matters.',
...

  {
    ...
    metaDescription:
      'How calipers are calibrated, the checks that matter (accuracy, parallelism, zero), what a good certificate shows, and how often to calibrate them.',
    category: 'Dimensional Metrology',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'The checks behind a micrometer calibration — accuracy across the range, anvil and spindle flatness and parallelism — and what belongs on the certificate.',
    category: 'Dimensional Metrology',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Gauge Block Calibration & Grades | American Gage',
    metaDescription:
      'Gauge blocks are the reference behind most dimensional calibration. How grades work (ASME B89, ISO 3650), how they are calibrated, and when to recalibrate.',
    category: 'Dimensional Metrology',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'CMM Calibration vs. Verification | American Gage',
    metaDescription:
      'Coordinate measuring machines are verified against standards like ISO 10360. The difference between CMM calibration, verification, and interim checks.',
    category: 'Dimensional Metrology',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Granite surface plates are the datum for a lot of dimensional work. How flatness is checked (ASME B89.3.7), why it matters, and how height gauges depend on it.',
    category: 'Dimensional Metrology',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Attribute gauges wear with use, and a worn gauge passes bad parts. How thread, ring, and plug gauges are calibrated, and when to retire one.',
    category: 'Dimensional Metrology',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Digital Multimeter (DMM) Calibration | American Gage',
    metaDescription:
      'How digital multimeters are calibrated across DC/AC volts, current, and resistance, why range and function coverage matters, and what the certificate shows.',
    category: 'Electrical & RF',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Oscilloscope calibration verifies vertical accuracy, timebase, and bandwidth. What a proper scope calibration covers and why the bandwidth check matters most.',
    category: 'Electrical & RF',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Power Supply & Source Calibration | American Gage',
    metaDescription:
      'Calibrating programmable power supplies and sources: output accuracy, readback, and load — and how source calibration differs from meter calibration.',
    category: 'Electrical & RF',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'RF & Microwave Calibration Explained | American Gage',
    metaDescription:
      'RF and microwave calibration covers power, attenuation, and network parameters across wide frequency ranges — and why automated systems are the practical way.',
    category: 'Electrical & RF',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Data Acquisition (DAQ) Calibration | American Gage',
    metaDescription:
      'DAQ systems combine channels, signal conditioning, and software. Why channel-by-channel calibration and end-to-end verification both matter for good data.',
    category: 'Electrical & RF',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Frequency & Time-Base Calibration | American Gage',
    metaDescription:
      'Time and frequency are the most accurately realized measurements. How frequency counters and instrument time bases are calibrated against a stable reference.',
    category: 'Electrical & RF',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'Pressure, Temperature & Environmental Cal | American Gage',
    metaDescription:
      'A guide to pressure, temperature, humidity, and chamber calibration: gauges and transducers, RTDs and thermocouples, data loggers, and deadweight testers.',
...

  {
    ...
    metaTitle: 'Pressure Gauge & Transducer Calibration | American Gage',
    metaDescription:
      'How pressure gauges and transducers are calibrated against deadweight testers and precision controllers, and what the certificate should show.',
    category: 'Pressure, Temp & Environmental',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'RTD & Thermocouple Calibration | American Gage',
    metaDescription:
      'How temperature sensors are calibrated in baths and dry-wells against reference thermometers, the difference between RTDs and thermocouples, and what to expect.',
    category: 'Pressure, Temp & Environmental',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'How relative humidity is calibrated with controlled generators, why humidity is coupled to temperature, and where humidity accuracy matters most.',
    category: 'Pressure, Temp & Environmental',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Chamber mapping proves temperature and humidity uniformity across a chamber, not just at the controller. How it is done and why regulated storage requires it.',
    category: 'Pressure, Temp & Environmental',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Temperature and humidity data loggers record the conditions your product experienced. Why they need traceable calibration and what a certificate should confirm.',
    category: 'Pressure, Temp & Environmental',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Deadweight testers realize highly accurate, traceable pressure. How they work, how they are calibrated, and when a precision controller is used instead.',
    category: 'Pressure, Temp & Environmental',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaTitle: 'Mass, Force & Torque Calibration Guide | American Gage',
    metaDescription:
      'A guide to mass, force, and torque calibration: balances and scales, weight classes, torque wrenches, force gauges and load cells, and crane scales.',
...

  {
    ...
    metaTitle: 'Balance & Scale Calibration Explained | American Gage',
    metaDescription:
      'How balances and scales are calibrated with classified reference weights — the checks that matter: accuracy, linearity, repeatability, and eccentricity.',
    category: 'Mass, Force & Torque',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaDescription:
      'Reference weights are classified by tolerance under ASTM E617 and OIML R111. What the classes mean and how to pick the right class for your balance.',
    category: 'Mass, Force & Torque',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Torque Wrench Calibration Guide | American Gage',
    metaDescription:
...

  {
    ...
    metaTitle: 'Torque Screwdriver Calibration | American Gage',
    metaDescription:
      'Low-range torque tools need calibration suited to their small torques. How torque screwdrivers are calibrated and where these tools are critical.',
    category: 'Mass, Force & Torque',
    readMinutes: 3,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Crane & Floor Scale Calibration | American Gage',
    metaDescription:
      'Large-capacity crane and floor scales are calibrated on-site with certified test weights. How it works and why capacity and eccentricity checks matter.',
    category: 'Mass, Force & Torque',
    readMinutes: 3,
    date: '2026-07-23',
    heroImage: {
  ...
  /* ================================================================== */
  {
    ...
    metaDescription:
      'The complete guide to running a calibration program: in-house vs. outsourced, choosing a lab, out-of-tolerance handling, MSA, audit prep, and the master list.',
...

  {
    ...
    metaTitle: 'In-House vs. Outsourced Calibration | American Gage',
    metaDescription:
      'The true cost of in-house calibration includes standards, accreditation, training, and time. A clear framework for what to keep in-house and what to send out.',
    category: 'Managing a Program',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'How to Choose a Calibration Lab (Checklist) | American Gage',
    metaDescription:
      'The complete checklist for selecting a calibration supplier: accreditation and scope, certificate content, capability, turnaround, logistics, and support.',
    category: 'Managing a Program',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Out-of-Tolerance Impact Assessments | American Gage',
    metaDescription:
...

  {
    ...
    metaTitle: 'Gauge R&R and MSA Basics | American Gage',
    metaDescription:
      'Measurement systems analysis (MSA) and gauge R&R quantify measurement-process variation, distinct from calibration. How they fit together and why you need both.',
    category: 'Managing a Program',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Preparing for a Calibration Audit | American Gage',
    metaDescription:
      'A prep checklist for the calibration part of an AS9100, ISO 13485, or IATF audit: records to have ready, the out-of-tolerance story, and supplier proof.',
    category: 'Managing a Program',
    readMinutes: 5,
    date: '2026-07-23',
    heroImage: {
...

  {
    ...
    metaTitle: 'Building a Calibration Equipment List | American Gage',
    metaDescription:
      'The equipment master list is the backbone of a calibration program. What fields it needs, how to keep it controlled, and how it drives recall and audits.',
    category: 'Managing a Program',
    readMinutes: 4,
    date: '2026-07-23',
    heroImage: {
